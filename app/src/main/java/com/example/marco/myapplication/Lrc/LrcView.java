package com.example.marco.myapplication.Lrc;
...
/**
 * Created by 56820 on 2016/12/15.
 */
public class LrcView extends android.widget.TextView{
    ...
    private float textSize = 33;        //文本大小
    ...
    protected void onDraw(Canvas canvas) {
        ...
        currentPaint.setColor(Color.argb(255, 255, 255, 29));
